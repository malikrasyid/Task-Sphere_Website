      ...
      <div class="flex items-center justify-between h-full px-3">
        ...
        <div class="flex items-center">            
          ...
          <div class="relative profile-button">
            ...
            <div 
              v-if="showDropdown" 
              class="absolute right-0 mt-2 w-48 bg-white border border-gray-200 rounded-xl py-1 z-50 transition ease-out duration-100"
            >
              <div class="px-4 py-3 text-sm text-gray-700 border-b border-gray-100 font-medium truncate">
                {{ fullName }}
              </div>
              <button 
                @click="$emit('logout')" 
